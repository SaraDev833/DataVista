...
const Sidenavbar = ({ showSidebar }) => {
  ...
  return (
    <div className={`h-screen w-[256px] shadow-md bg-white flex-col fixed top-0 left-0 z-50 pt-[16px] px-[28px] lg:flex ${showSidebar ? 'block transition-transform duration-300 ease-in-out' : 'hidden'}`}>
